...
namespace RTCHikSdk
{
    public partial class FrmMain : Form
    {
        ...
        MyHikCamera.MV_CC_DEVICE_INFO_LIST m_stDeviceList = new MyHikCamera.MV_CC_DEVICE_INFO_LIST();
        private MyHikCamera m_MyCamera = new MyHikCamera();
        bool m_bGrabbing = false;
        Thread m_hReceiveThread = null;
        MyHikCamera.MV_FRAME_OUT_INFO_EX m_stFrameInfo = new MyHikCamera.MV_FRAME_OUT_INFO_EX();
        ...
        private Boolean IsMonoData(MyHikCamera.MvGvspPixelType enGvspPixelType)
        {
         ...
         ************************************************************************/
        private Boolean IsColorData(MyHikCamera.MvGvspPixelType enGvspPixelType)
        {
            switch (enGvspPixelType)
            {
        ...
        private void DeviceListAcq()
        {
            ...
            int nRet = MyHikCamera.MV_CC_EnumDevices_NET(MyHikCamera.MV_GIGE_DEVICE | MyHikCamera.MV_USB_DEVICE, ref m_stDeviceList);
            if (0 != nRet)
            {
            ...
            {
                MyHikCamera.MV_CC_DEVICE_INFO device = (MyHikCamera.MV_CC_DEVICE_INFO)Marshal.PtrToStructure(m_stDeviceList.pDeviceInfo[i], typeof(MyHikCamera.MV_CC_DEVICE_INFO));
        ...
        private void bnOpen_Click(object sender, EventArgs e)
        {
            ...
            MyHikCamera.MV_CC_DEVICE_INFO device = 
                (MyHikCamera.MV_CC_DEVICE_INFO)Marshal.PtrToStructure(m_stDeviceList.pDeviceInfo[cbDeviceList.SelectedIndex],
                                                              typeof(MyHikCamera.MV_CC_DEVICE_INFO));

            // ch:打开设备 | en:Open device
            if (null == m_MyCamera)
            {
                m_MyCamera = new MyHikCamera();
                if (null == m_MyCamera)
                {
                    ShowErrorMsg("Applying resource fail!", MyHikCamera.MV_E_RESOURCE);
                    return;
                }
            }
            ...
            m_MyCamera.MV_CC_SetEnumValue_NET("AcquisitionMode", (uint)MyHikCamera.MV_CAM_ACQUISITION_MODE.MV_ACQ_MODE_CONTINUOUS);
            m_MyCamera.MV_CC_SetEnumValue_NET("TriggerMode", (uint)MyHikCamera.MV_CAM_TRIGGER_MODE.MV_TRIGGER_MODE_OFF);
        ...
        private void bnTriggerMode_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                m_MyCamera.MV_CC_SetEnumValue_NET("TriggerMode", (uint)MyHikCamera.MV_CAM_TRIGGER_MODE.MV_TRIGGER_MODE_ON);
                ...
                {
                    m_MyCamera.MV_CC_SetEnumValue_NET("TriggerSource", (uint)MyHikCamera.MV_CAM_TRIGGER_SOURCE.MV_TRIGGER_SOURCE_SOFTWARE);
                    if (m_bGrabbing)
                    {
                ...
                {
                    m_MyCamera.MV_CC_SetEnumValue_NET("TriggerSource", (uint)MyHikCamera.MV_CAM_TRIGGER_SOURCE.MV_TRIGGER_SOURCE_LINE0);
                }
        ...
        {
            MyHikCamera.MV_FRAME_OUT stFrameInfo = new MyHikCamera.MV_FRAME_OUT();
            MyHikCamera.MV_DISPLAY_FRAME_INFO stDisplayInfo = new MyHikCamera.MV_DISPLAY_FRAME_INFO();
            MyHikCamera.MV_PIXEL_CONVERT_PARAM stConvertInfo = new MyHikCamera.MV_PIXEL_CONVERT_PARAM();
            int nRet = MyHikCamera.MV_OK;

            while (m_bGrabbing)
            {
                nRet = m_MyCamera.MV_CC_GetImageBuffer_NET(ref stFrameInfo, 5000);
                if (nRet == MyHikCamera.MV_OK)
                {
                    lock (BufForDriverLock)
                    {
                        ...
                        {
                            stConvertInfo.enDstPixelType = MyHikCamera.MvGvspPixelType.PixelType_Gvsp_Mono8;
                            m_MyCamera.MV_CC_ConvertPixelType_NET(ref stConvertInfo);
                        }
                        else
                        {
                            stConvertInfo.enDstPixelType = MyHikCamera.MvGvspPixelType.PixelType_Gvsp_BGR8_Packed;
                            m_MyCamera.MV_CC_ConvertPixelType_NET(ref stConvertInfo);
                        }
                        ...
                        //HOperatorSet.GenImageInterleaved(out hObject, bitmapData.Scan0, "bgrx", m_bitmap.Width, m_bitmap.Height, 0, "byte", 0, 0, 0, 0, -1, 0);
        ...
        private Boolean IsMono(UInt32 enPixelType)
        {
            switch (enPixelType)
            {
                case (UInt32)MyHikCamera.MvGvspPixelType.PixelType_Gvsp_Mono1p:
                case (UInt32)MyHikCamera.MvGvspPixelType.PixelType_Gvsp_Mono2p:
                case (UInt32)MyHikCamera.MvGvspPixelType.PixelType_Gvsp_Mono4p:
                case (UInt32)MyHikCamera.MvGvspPixelType.PixelType_Gvsp_Mono8:
                case (UInt32)MyHikCamera.MvGvspPixelType.PixelType_Gvsp_Mono8_Signed:
                case (UInt32)MyHikCamera.MvGvspPixelType.PixelType_Gvsp_Mono10:
                case (UInt32)MyHikCamera.MvGvspPixelType.PixelType_Gvsp_Mono10_Packed:
                case (UInt32)MyHikCamera.MvGvspPixelType.PixelType_Gvsp_Mono12:
                case (UInt32)MyHikCamera.MvGvspPixelType.PixelType_Gvsp_Mono12_Packed:
                case (UInt32)MyHikCamera.MvGvspPixelType.PixelType_Gvsp_Mono14:
                case (UInt32)MyHikCamera.MvGvspPixelType.PixelType_Gvsp_Mono16:
                    return true;
                default:
                    return false;
            }
        ...
        private Int32 NecessaryOperBeforeGrab()
        {
            ...
            MyHikCamera.MVCC_INTVALUE_EX stWidth = new MyHikCamera.MVCC_INTVALUE_EX();
            ...
            MyHikCamera.MVCC_INTVALUE_EX stHeight = new MyHikCamera.MVCC_INTVALUE_EX();
            ...
            MyHikCamera.MVCC_ENUMVALUE stPixelFormat = new MyHikCamera.MVCC_ENUMVALUE();
            ...
            if ((Int32)MyHikCamera.MvGvspPixelType.PixelType_Gvsp_Undefined == stPixelFormat.nCurValue)
            {
                ShowErrorMsg("Unknown Pixel Format!", MyHikCamera.MV_E_UNKNOW);
                return MyHikCamera.MV_E_UNKNOW;
            }
            else if (IsMono(stPixelFormat.nCurValue))
            {
                ...
                if (IntPtr.Zero == m_ConvertDstBuf)
                {
                    ShowErrorMsg("Malloc Memory Fail!", MyHikCamera.MV_E_RESOURCE);
                    return MyHikCamera.MV_E_RESOURCE;
                }
            }
            else
            {
        ...
        private void bnStartGrab_Click(object sender, EventArgs e)
        {
            ...
            m_stFrameInfo.enPixelType = MyHikCamera.MvGvspPixelType.PixelType_Gvsp_Undefined;
        ...
        private void bnSaveBmp_Click(object sender, EventArgs e)
        {
            ...
            MyHikCamera.MV_SAVE_IMG_TO_FILE_PARAM stSaveFileParam = new MyHikCamera.MV_SAVE_IMG_TO_FILE_PARAM();
            ...
            lock (BufForDriverLock)
            {
                ...
                stSaveFileParam.enImageType = MyHikCamera.MV_SAVE_IAMGE_TYPE.MV_Image_Bmp;
        ...
        private void bnSaveJpg_Click(object sender, EventArgs e)
        {
            ...
            lock (BufForDriverLock)
            {
                ...
                stSaveFileParam.enImageType = MyHikCamera.MV_SAVE_IAMGE_TYPE.MV_Image_Jpeg;
                stSaveFileParam.enPixelType = m_stFrameInfo.enPixelType;
                stSaveFileParam.pData = m_BufForDriver;
                stSaveFileParam.nDataLen = m_stFrameInfo.nFrameLen;
                stSaveFileParam.nHeight = m_stFrameInfo.nHeight;
        ...
        private void bnSavePng_Click(object sender, EventArgs e)
        {
            ...
            lock (BufForDriverLock)
            {
                ...
                stSaveFileParam.enImageType = MyHikCamera.MV_SAVE_IAMGE_TYPE.MV_Image_Png;
                stSaveFileParam.enPixelType = m_stFrameInfo.enPixelType;
                stSaveFileParam.pData = m_BufForDriver;
                stSaveFileParam.nDataLen = m_stFrameInfo.nFrameLen;
                stSaveFileParam.nHeight = m_stFrameInfo.nHeight;
        ...
        private void bnSaveTiff_Click(object sender, EventArgs e)
        {
            ...
            lock (BufForDriverLock)
            {
                ...
                stSaveFileParam.enImageType = MyHikCamera.MV_SAVE_IAMGE_TYPE.MV_Image_Tif;
                stSaveFileParam.enPixelType = m_stFrameInfo.enPixelType;
                stSaveFileParam.pData = m_BufForDriver;
                stSaveFileParam.nDataLen = m_stFrameInfo.nFrameLen;
                stSaveFileParam.nHeight = m_stFrameInfo.nHeight;
        ...
        {
            MyHikCamera.MVCC_FLOATVALUE stParam = new MyHikCamera.MVCC_FLOATVALUE();
