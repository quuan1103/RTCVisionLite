...
{
    public partial class ucCsvWriteActionDetail : ucBaseActionDetail
    {
                ...
                if (currentColumn.RefID == Guid.Empty)
                {
                    try
                    {
                        ...
                        else
                        {
                            ...
                            if (OnCsvWriteBtnLinkValueClickEvent != null)
                            {
                                RTCE_CsvWrite_RowCellClickEventArgs eventArgs =
                                    new RTCE_CsvWrite_RowCellClickEventArgs
                                    {
                                        View = this,
                                ...
                                OnCsvWriteBtnLinkValueClickEvent(this, eventArgs);
                            }
                        }
                    }
                    catch (Exception ex)
