...
namespace RTC_Vision_Lite.Forms
{
    ...
    public partial class FrmActions : FrmBase
    {
        ...
        private void ucActionList_Load(object sender, EventArgs e)
        {

        }

        private void ucTemplateTools_Load(object sender, EventArgs e)
        {

        }

        private void PanHsmartWindow_Paint(object sender, PaintEventArgs e)
        {
